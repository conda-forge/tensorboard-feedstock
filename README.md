About tensorboard-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensorboard-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1994&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensorboard-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensorboard` can be installed with `conda`:
...
It is possible to list all of the versions of `tensorboard` available on your platform with `conda`:
...
```
mamba search tensorboard --channel conda-forge
```
...
mamba repoquery search tensorboard --channel conda-forge

# List packages depending on `tensorboard`:
mamba repoquery whoneeds tensorboard --channel conda-forge

# List dependencies of `tensorboard`:
mamba repoquery depends tensorboard --channel conda-forge
```
